        ...
        <div class="bg-white   p-6 rounded-lg shadow-md">
            <form action="{{ route('posts.update', $post) }}" method="POST">
                ...
                <div class="flex flex-col md:flex-row md:space-x-6">
                    ...
                    <div class="md:w-1/2">
                        <label for="caption" class="block text-sm font-medium  text-secondary]">Caption</label>
                        <textarea name="caption" id="caption" rows="8"
                            class="mt-1 block w-full border rounded-md shadow-sm   p-1">{{ old('caption', $post->caption) }}</textarea>
